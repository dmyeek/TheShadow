...
public class MapManager {
    ...
    public MapManager(int col, int row) {
        ...
        StageData bedroom = new StageData("침실", createBaseMap(col, row));
        bedroom.addDoor(950, 330, 30, 100, "복도_왼쪽"); 

        // [일기장 설정] 대형 책상의 윗줄 왼쪽 구역인 (Col:4, Row:10) 타일 내부로 정밀 조절
        String tutorialText = "[낡은 일기장]\n\n"
                + "1. WASD 키를 사용하여 이동할 수 있습니다.\n"
                + "2. 문(파란색 영역)에 닿으면 다른 방으로 이동합니다.\n"
                + "3. 붉은색 괴물과 마주치면 타이핑 결투가 시작됩니다.\n"
                + "4. 화면에 나오는 단어를 올바르게 타이핑하여 괴물을 공격하세요.\n"
                + "5. 잠긴 문을 통과하려면 괴물을 처치하고 얻는 '열쇠'가 필요합니다.";
        ...
        bedroom.setStructure(19, 1, 5); 
        bedroom.setStructure(19, 2, 5);
        bedroom.setStructure(19, 3, 5);
        bedroom.setStructure(19, 4, 5);
        ...
        // --- 2. 복도 시리즈 ---
        StageData hallwayL = new StageData("복도_왼쪽", createAdvancedMap(col, row, false, true, false, false));
        ...
        StageData hallwayC = new StageData("복도_중앙", createAdvancedMap(col, row, true, true, false, false));
        ...
        // --- 3. 중앙계단 시리즈 ---
        StageData stairs1 = new StageData("중앙계단1", createAdvancedMap(col, row, false, false, false, true));
        stairs1.addDoor(460, 48, 100, 10, "복도_중앙"); 
        stairs1.addDoor(0, 760, 1008, 10, "중앙계단2");
        roomMap.put("중앙계단1", stairs1);
        
        StageData stairs2 = new StageData("중앙계단2", createAdvancedMap(col, row, false, false, true, false));
        stairs2.addDoor(0, 0, 1008, 10, "중앙계단1"); 
        stairs2.addDoor(460, 710, 100, 10, "거실"); 
        roomMap.put("중앙계단2", stairs2);

        // --- 4. 거실 및 나머지 구역 ---
        StageData livingRoom = new StageData("거실", createAdvancedMap(col, row, false, false, false, false));
        ...
        //선반
        livingRoom.setStructure(5, 5, 10);
        livingRoom.setStructure(15, 5, 10);
        ...
        StageData hallwayR = new StageData("복도_오른쪽", createAdvancedMap(col, row, true, false, false, false));
        ...
        // 일반 방들
        StageData room1 = new StageData("방1", createBaseMap(col, row));
        room1.addDoor(200, 48, 100, 10, "복도_왼쪽");
        roomMap.put("방1", room1);
        
        StageData room2 = new StageData("방2", createBaseMap(col, row));
        room2.addDoor(700, 48, 100, 10, "복도_오른쪽");
        roomMap.put("방2", room2);
        
        StageData room3 = new StageData("방3", createBaseMap(col, row));
        room3.addDoor(48, 330, 10, 100, "복도_오른쪽");
        room3.addDoor(460, 48, 100, 10, "방4");
        roomMap.put("방3", room3);

        StageData room4 = new StageData("방4", createBaseMap(col, row));
        room4.addDoor(460, 710, 100, 10, "방3");
        roomMap.put("방4", room4);
        
        StageData EsCapeR = new StageData("탈출", createAdvancedMap(col, row, true, true, false,true));
